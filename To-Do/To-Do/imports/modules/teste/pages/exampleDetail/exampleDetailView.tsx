...
import { TesteDetailControllerContext } from './testeDetailContoller';
import { TesteModuleContext } from '../../testeContainer';
import TesteDetailStyles from './testeDetailStyles';
...
const TesteDetailView = () => {
	const controller = useContext(TesteDetailControllerContext);
	const { state } = useContext(TesteModuleContext);
...
export default TesteDetailView;
